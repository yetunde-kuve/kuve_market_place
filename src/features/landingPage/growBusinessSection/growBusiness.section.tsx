  ...
  const features = [
    {
      ...
      description:
        "Set up your store by organising products into categories for a professional look",
    },
    {
      icon: "/img/boostIcon.svg",
      title: "Boost Your Visibility",
      description:
        "Advertise your business to attract more local buyers and increase your sales",
    },
    {
      icon: "/img/customerIcon.svg",
      title: "Engage with Customers",
      description:
        "Connect directly with buyers, answer inquiries, and build customer trust.",
    },
    {
      icon: "/img/dashboardIcon.svg",
      title: "Smart Sales Dashboard",
      description:
        "Track your sales, inventory, and performance in one easy-to-use dashboard",
    },
  ];
    ...
    <section className="md:py-[48px] md:px-[32px] py-[39px] px-[20px] lg:py-[73px] xl:px-[88px] lg:px-[38px] xl:mx-[-88px] lg:mx-[-38px]  md:mx-[-32px] mx-[-16px]">
      <div>
        ...
        <div className="mb-12 text-center md:mb-16">
          ...
          <p className="max-w-2xl mx-auto text-sm text-text-secondary md:text-base">
            Reach more customers, promote your brand, and manage your sales with
            our powerful tools designed for businesses.
          </p>
        </div>

        <div className="grid grid-cols-1 gap-4 mb-12 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 lg:gap-6 xl:gap-6">
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="mt-4 mb-2 text-lg font-semibold text-text">
                {feature.title}
              </h3>
