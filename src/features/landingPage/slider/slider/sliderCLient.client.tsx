...
const SliderClient = ({ products }: SliderClientProps) => {
  ...
  useEffect(() => {
    if (products.length === 0) return; // Don't start auto-slide if no data
  ...
  return (
    <div className="relative w-full lg:h-[310px] md:h-auto h-[168px]">
      ...
      <div className="relative flex items-center justify-between w-full h-full gap-6 lg:gap-20 md:gap-10">
        ...
        <div className="justify-end flex-shrink-0 py-2 md:pr-16 lg:pr-28">
          <Image
