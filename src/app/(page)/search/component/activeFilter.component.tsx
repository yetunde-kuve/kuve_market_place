export default function SearchActiveFilter() {
  return (
    <div className="bg-white flex justify-between md:items-center md:flex-row flex-col gap-[10px] rounded-[8px] px-[10px] py-[8px] md:px-[24px] md:py-[12px] mb-[20px]">
      <div className="flex items-center md:gap-4 gap-[8px] flex-wrap md:order-1 order-2">
        <p className="md:text-[14px] text-[10px] text-[#5F6C72] font-[400]">Active Filters:</p>

        <button className="md:text-[14px] text-[10px]  items-center text-[400] text-[#191C1F] flex gap-[6px]">
          Electronics Devices
      ...
      <div>
        <p className="md:text-[14px] text-[10px] text-[#5F6C72] font-[400] md:order-2 order-1">
