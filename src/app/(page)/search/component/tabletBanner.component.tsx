...
export default function TabletBannner() {
  return (
    <div className="w-full gap-4 grid grid-cols-3 bg-[#FFF5F5] border border-[#FF9D98] p-12">
      <div>
        <Image
          src={Watch}
      ...
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center gap-4 text-center ">
          <p className="text-[20px] font-[600] text-[#191C1F]">
