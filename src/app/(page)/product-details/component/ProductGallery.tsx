  ...
  return (
    <>
      <div className="flex flex-col gap-4 ">
        {/* Main Image */}
        <div className="relative aspect-square w-full h-[400.16px]  xl:h-[631px] lg:h-[496.38px] ">
          <Image
          ...
          <button
            onClick={() => openModal()}
            className="absolute p-2 transition-all duration-200 top-4 right-4"
        ...
        <div className="relative">
          ...
          <div
            ...
            className="flex w-full gap-2 overflow-x-auto scrollbar-hide scroll-smooth "
            style={{
              scrollbarWidth: "none",
