    ...
    return (
        <div className="hidden lg:flex lg:w-1/2 relative w-[709px] text-white m-3">
            ...
            <div className="relative z-10 flex flex-col justify-end p-12">
                ...
                <h1 className="text-6xl font-normal mb-6">Get<br />Everything<br />you want!</h1>
                <p className="text-[15.56px]">
                    You can get everything you want if you work<br/> hard, trust the process, and stick to the plan.
                </p>
            </div>
        </div>
    );
